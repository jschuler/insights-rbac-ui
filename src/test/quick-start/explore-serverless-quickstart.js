export const exploreServerlessQuickStart = {
  ...
  spec: {
    ...
    durationMinutes: 10,
    description: `RBAC: Install the OpenShift Serverless Operator to deploy stateless, event-trigger-based applications.`,
    introduction: `RBAC: Red Hat® OpenShift® Serverless lets you run stateless, serverless workloads on a single multi-cloud container platform.
